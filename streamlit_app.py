    ...
    with st.spinner("Searching..."):
        try:
            ...
            if response.status_code == 200:
                ...
                st.info(f"Found {results['total']} results ({results['time_ms']:.0f}ms)")
...
with st.form("search_form"):
    search_query = st.text_input("Search", placeholder="neural networks, machine learning...", label_visibility="collapsed")
...
if not search_query:
    ...
    queries = ["neural networks", "machine learning", "computer vision", 
